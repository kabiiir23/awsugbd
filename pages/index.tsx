...
export default function Home(props) {
  ...
  return (
    <MainLayout
      pageTitle='AWS User Group Bangladesh'
        ...
        <section className={style.userGroup} id='userGroup'>
          ...
          >
            ...
            <p>
              ...
              Amazon Web Services (AWS) professionals in order to share and
              create knowledge and mutual benefit. This is the only Amazon
              approved AWS user group in Bangladesh. Also we'd like to help
              people out with their queries about cloud platform for their
              practical uses. We are mainly focusing on Amazon Web Services for
              now. With time, there might be other cloud platforms to discuss,
              explore and experience. But for now we are here with a view to
              help cloud service seekers to find a common platform much more
              convenient than the conventional manner.
            </p>
          </div>
